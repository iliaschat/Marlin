...
#define STRING_CONFIG_H_AUTHOR "(ili, AnetA6 config)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "ili-A6"
...
// 120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  ...
  // ANET A6 - autotuned by ili
  // M303 E-1 S60 C8 : M304 K109.50 I14.85 D538.18
  #define DEFAULT_BED_KP 160.50
  #define DEFAULT_BED_KI 14.85
  #define DEFAULT_BED_KD 538.18
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100,  99.6, 392.15, 100 }
...
// #define DEFAULT_EJERK    5.0  // May be used by Linear Advance too!
...
// ANET A6 with BLTouch/3D-Touch mounted front-right to the nozzle
#define NOZZLE_TO_PROBE_OFFSET { 23, -23, 0 }
...
#define XY_AFTER_HOMING { 10, 220 }  // (mm) Move to an XY position after homing (and raising Z)
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (PROBING_MARGIN)    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT (Y_MAX_POS - PROBING_MARGIN)    // Y point for Z homing when homing all axes (G28).
